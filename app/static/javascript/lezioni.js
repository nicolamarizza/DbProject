    ...
    $(document).ready(function() {
        ...
        function resetDefaultAule(){
            ...
            $(default_values_idaula).each(function(i){
                $("#idaula").append(`<option selected value="${default_values_idaula[i].value}">${default_values_idaula[i].display}</option>`);
            });
        }
        ...
        function remoto(arr) {
            $("#modalita").empty();
            $("#modalita").append(`<option disabled value="">modalita</option>`);
            $("#modalita").append(`<option selected value="${arr[0].value}">${arr[0].display}</option>`);
             
            $("#idaula").empty();
            $("#idaula").append(`<option disabled value="">aula</option>`);
            $("#idaula").append(`<option selected id="aulavirtuale" value="virtual">aula virtuale</option>`);
        }
