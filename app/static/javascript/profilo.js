...
function validateForm(real_psw) {
  ...
  if (SHA512(old_psw) != real_psw) {
      document.forms["form_edit_profile"]["old"].value = "";
    ...
    /*quando invia i dati, disabilita l'input type text dove è scritta
    la vecchia password in modo da non inviarla!*/
    document.forms["form_edit_profile"]["old"].disabled = true;
}
